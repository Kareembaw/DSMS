...
<html>
<head>
  <title>Instructor Print Salary</title>
...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  ...
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="../InstructorView/Instructor_PrintSalarySlip.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Print Salary</a>
        ...
        <form method="POST">
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <table style="margin-left: 600px;margin-right: auto;width: 800px;margin-top: 40px;">
              <tr>
                <td style="text-align: center;padding-right: 20px;" colspan="2"><h3>PRINT SALARY</h3></td>
              </tr>
              <tr>
